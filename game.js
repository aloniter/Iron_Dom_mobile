class IronDOMGame {
    ...
    updateTrumpAnimation(deltaTime) {
        ...
        // Start text fade in when Trump reaches center
        if (this.trumpAnimation.x <= this.canvasWidth / 2 && !this.trumpAnimation.textFadeIn) {
            this.trumpAnimation.textFadeIn = true;
        }
        
        // Fade in text
        if (this.trumpAnimation.textFadeIn && this.trumpAnimation.textAlpha < 1) {
            this.trumpAnimation.textAlpha += deltaTime / 500; // Fade in over 0.5 seconds
        }
        
        // End animation when Trump exits screen and enough time has passed
        if (this.trumpAnimation.x <= -this.trumpAnimation.width && this.trumpAnimation.duration > 2500) {
