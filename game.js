class IronDOMGame {
    ...
    updateTrumpAnimation(deltaTime) {
        ...
        // End animation when Trump exits screen and enough time has passed (even longer duration)
        if (this.trumpAnimation.x <= -this.trumpAnimation.width && this.trumpAnimation.duration > 7000) {
